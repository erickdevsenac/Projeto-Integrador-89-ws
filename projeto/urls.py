...
from core.viewsets import categoriaViewset, vendedorViewset,doacaoViewsets,produtoViewset,cadastro_produtoViewset
...
router.register(r'users',produtoViewset.ProdutoViewSet)
