# Generated by Django 5.2.3 on 2026-01-29 20:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "nome",
                    models.CharField(
                        help_text="Nome descritivo do cupom", max_length=100
                    ),
                ),
                (
                    "descricao",
                    models.TextField(
                        blank=True, help_text="Descrição detalhada da promoção"
                    ),
                ),
                (
                    "tipo_desconto",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "resumo",
                    models.CharField(
                        help_text="Um resumo curto que aparecerá no card da dica.",
                        max_length=255,
                    ),
                ),
                (
                    "conteudo",
                    models.TextField(help_text="O conteúdo completo da dica."),
                ),
                (
                    "imagem",
                    models.ImageField(blank=True, null=True, upload_to="dicas/"),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "numero_pedido",
                    models.CharField(
                        default=core.models.pedido.gerar_numero_pedido,
                        editable=False,
                        max_length=30,
                        unique=True,
                    ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cep",
                    models.CharField(
                        help_text="CEP no formato 00000-000", max_length=10
                    ),
                ),
                ...
                ("objetivo", models.TextField(verbose_name="Objetivos da ONG")),
                (
                    "avaliacao_media",
                    models.DecimalField(
                        decimal_places=2,
                ...
                (
                    "ativo",
                    models.BooleanField(
                        default=True, help_text="Perfil ativo no sistema."
                    ),
                ),
            ],
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["tipo", "ativo"], name="core_perfil_tipo_fccd27_idx"
                    ),
                    models.Index(
                        fields=["cidade", "estado"],
                        name="core_perfil_cidade_e1c22e_idx",
                    ),
                ],
            },
        ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(
                        default=False,
                        help_text="Marque para destacar o produto na página inicial.",
                    ),
                ),
                (
                    "visualizacoes",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.DateField(
                        blank=True,
                        help_text="Data até a qual o pacote estará disponível.",
                        null=True,
                    ),
                ),
                (
                    "nome",
                    models.CharField(default="Pacote Surpresa do Dia", max_length=100),
                ),
                (
                    "descricao",
                    models.TextField(
                ...
                (
                    "imagem",
                    models.ImageField(blank=True, null=True, upload_to="pacotes/"),
                ),
                ("quantidade_estoque", models.PositiveIntegerField(default=0)),
                ("ativo", models.BooleanField(default=True)),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.DecimalField(
                        decimal_places=2,
                        max_digits=10,
                        verbose_name="Preço Unitário na Compra",
                    ),
                ),
                (
                    "pacote_surpresa",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "tempo_preparo",
                    models.PositiveIntegerField(help_text="Tempo em minutos"),
                ),
                (
                    "rendimento",
                    models.CharField(
                        help_text="Ex: '8 porções' ou 'Serve 4 pessoas'", max_length=50
                    ),
                ),
                (
                    "imagem",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "ordem",
                    models.PositiveIntegerField(
                        help_text="A ordem do passo (1, 2, 3...)"
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        ...
                        name="core_avalia_content_cfe914_idx",
                    )
                ],
            },
        ),
        ...
        migrations.AddIndex(
            model_name="cupom",
            index=models.Index(
                fields=["ativo", "data_validade"], name="core_cupom_ativo_295b79_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="produto",
            index=models.Index(
                ...
                name="core_produt_ativo_858f05_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="produto",
            index=models.Index(
                fields=["categoria", "ativo"], name="core_produt_categor_da8b0a_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="produto",
            index=models.Index(
                fields=["vendedor", "ativo"], name="core_produt_vendedo_7d53f0_idx"
            ),
        ),
    ]
