# Generated by Django 5.2.3 on 2026-01-29 20:34
# Generated by Django 5.2.3 on 2026-01-29 20:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('telefone', models.CharField(blank=True, help_text='Telefone com DDD, ex: (11) 99999-9999', max_length=20)),
                ('endereco', models.CharField(max_length=255)),
                ('cep', models.CharField(help_text='CEP no formato 00000-000', max_length=10)),
                ('cidade', models.CharField(max_length=100)),
                ('estado', models.CharField(help_text='Sigla do estado, ex: SP', max_length=2)),
                ('nome_completo', models.CharField(help_text='Nome completo do cliente.', max_length=255, verbose_name='Nome Completo')),
                ('nome_negocio', models.CharField(help_text='O nome comercial do vendedor ou da ONG.', max_length=255, verbose_name='Nome da Loja/ONG')),
                ('cnpj', models.CharField(blank=True, default=None, help_text='Obrigatório para Vendedores e ONGs.', max_length=18, null=True, unique=True, verbose_name='CNPJ')),
                ('descricao_parceiro', models.TextField(help_text='Uma breve descrição sobre o parceiro.', verbose_name='Descrição da Empresa/ONG')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_quantidade', models.CharField(choices=[('PESA', 'Kg'), ('MEDE', 'Litros'), ('QUANTIA', 'Unidade')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantidade_estoque', models.PositiveIntegerField(default=0)),
                ('ativo', models.BooleanField(default=True)),
                ('vendedor', models.ForeignKey(limit_choices_to={'tipo': 'VENDEDOR'}, on_delete=django.db.models.deletion.CASCADE, related_name='pacote', to='core.perfil')),
