...
class Receita(models.Model):
    ...
    rendimento = models.CharField(
        max_length=50, help_text="Ex: '8 porções' ou 'Serve 4 pessoas'"
    )
    ...
    data_criacao = models.DateTimeField(default=timezone.now, auto_now_add=True)
...
class Ingrediente(models.Model):
    ...
    receita = models.ForeignKey(
        Receita, on_delete=models.CASCADE, related_name="ingredientes"
    )
    nome = models.CharField(max_length=100)
